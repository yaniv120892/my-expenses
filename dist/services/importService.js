...
class ImportService {
    ...
    async getImports(userId) {
        const imports = await importRepository_1.importRepository.findByUserId(userId);
        return imports.map((imp) => {
            const { _count } = imp, importData = __rest(imp, ["_count"]);
            return Object.assign(Object.assign({}, importData), { isVerified: _count.transactions === 0 });
        });
    }
