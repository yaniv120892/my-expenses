...
router.post('/', (0, validation_1.validateRequest)(requests_1.CreateScheduledTransactionRequest), (0, handleRequest_1.handleRequest)((req) => scheduledTransactionController_1.default.create(req.body), 201));
router.put('/:id', (0, validation_1.validateRequest)(requests_1.UpdateScheduledTransactionRequest), (0, handleRequest_1.handleRequest)((req) => scheduledTransactionController_1.default.update(req.params.id, req.body), 200));
