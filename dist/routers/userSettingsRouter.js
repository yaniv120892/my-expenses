...
router.post('/testTelegram', (0, validation_1.validateRequest)(requests_1.TestTelegramRequest), (0, handleRequest_1.handleRequest)((req) => userSettingsController_1.default.testTelegram(req.body.chatId), 200));
